...
MYSQL_JDBC_DRIVER=$PIO_HOME/lib/mysql-connector-java-8.0.15.jar
...
# MySQL Example
 ...
 PIO_STORAGE_SOURCES_MYSQL_URL=jdbc:mysql://localhost:3306/modelparam
 PIO_STORAGE_SOURCES_MYSQL_USERNAME=root
 PIO_STORAGE_SOURCES_MYSQL_PASSWORD=admin
